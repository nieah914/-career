...
| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명     | 10여개의 음원 배급사를 통해 월 60만건의 데이터 분류 및 집계하여 월별 정산서 엑셀 출력 |
| 언어     | Python3, PyQT5|
| DB       | Mysql|
| 소스관리 | Git|
| 서버     | NCP |
...
| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명  | Nodejs를 이용한 정산 관리 웹 사이트 개발|
| 언어  | Node js, Javascript, Pug|
| DB    | Mysql|
| 소스관리 | Git|
| 프레임워크 | Express|
| 서버     | NCP |
...
### 1) 출석체크 스터디를 위한 챗봇 프로그램

| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명 | 아침 스터디 기록을 위한 텔레그램 챗봇 프로그램 개발|
| 언어 | Python3|
| DB    | Mysql|
| 소스관리 | Git|
| 서버     | NCP |
...
| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명 | 카메라를 이용하여 Edge Detecting 후 사용자의 초기 자세 세팅후 임계값을 넘어가면 자세 교정에 대한 알림이 나타남|
| 언어 | Python3|
| DB   | Mysql|
| 소스관리 | Git|
| 서버     | NCP |
...
| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명 | 회사 모든 어플들의 댓글 크롤링을 통해 CS 부서의 응대 내용 확인 및 서비스 관리를 위한 크롤러|
| 언어 | Python3, PyQt5|
| DB   | MS-SQL|
| 소스관리 | Git|
| 서버     | ON-PREMISE |
...
### 5) Todo List 및 학습 관리 프로그램

| 항목    | 내용  | 
|-------|-------------------------------------------------------|
| 설명     | 업무관리를 위한 Todilist + 학습을 위한 스케쥴러|
| 언어     | Python3, PyQt5|
| DB       | MS-SQL|
| 소스관리 | Git|
| 서버     | ON-PREMISE |
...
### 7) 사내 가이드 라인을 위한 스트리밍 서버 및 녹화 프로그램
